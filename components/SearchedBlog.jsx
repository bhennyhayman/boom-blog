...
function SearchedBlog({blogs, setBlogs}) {
  ...
  if (filteredBlogs.length === 0) {
    return (<>
    <div className="flex flex-col justify-center items-center max-sm:text-[20px] text-2xl font-bold my-50">
        <div className="">No results found</div>
        <div className="">Try searching for another title</div>
        <div className="mt-5 max-sm:text-sm text-blue-300"> <Link to='/blogs'>Go back to blogs</Link></div>
    </div>
